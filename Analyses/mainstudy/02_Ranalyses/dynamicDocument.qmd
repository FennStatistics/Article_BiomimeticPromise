...
```{r}
dat$socio_employment <- factor(dat$socio_employment)
dat$socio_ethnicity <- factor(dat$socio_ethnicity)
dat$socio_sex <- factor(dat$socio_sex)
dat$socio_sex <- factor(dat$socio_sex)

dat$framingCondition <- as.factor(dat$framingCondition)
```
...
## Descriptives, correlation plot, EFA, CFA for "Ecological Items"
...
## Descriptives, correlation plot, EFA, CFA for "Bioinspiration Items"
...
## test for measurment invariance
...
dat %>% 
  ...
  summarise(N = n(), mean_Ecological=mean(mean_Ecological), 
            mean_Bioinspiration=mean(mean_Bioinspiration), 
            mean_Bioinspiration_PN=mean(mean_Bioinspiration_PN), 
            mean_Bioinspiration_IPI=mean(mean_Bioinspiration_IPI), 
            mean_Bioinspiration_VRtN=mean(mean_Bioinspiration_VRtN))
```
...
times condition? latent classes within condition?
...
## latent class analysis for "Bioinspiration Items"

*to come*

## latent class analysis for "Ecological Items"
